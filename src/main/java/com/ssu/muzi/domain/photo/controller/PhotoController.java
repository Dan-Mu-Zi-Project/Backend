...
import static com.ssu.muzi.global.result.code.PhotoResultCode.DELETE_PHOTO;
...
public class PhotoController {
    ...
    @Operation(summary = "사진 삭제 API", description = "사진을 삭제하는 API입니다.")
    public ResultResponse<PhotoResponse.PhotoDeleteInfo> deletePhotoList(@Valid @RequestBody PhotoRequest.PhotoDelete request) {;
        return ResultResponse.of(DELETE_PHOTO,
